...
<!-- <form id="mainFrm" action="main.do">
	<input type="checkbox" class="arrCheck" name="arrCheck" value="1">
	<input type="checkbox" class="arrCheck" name="arrCheck" value="2">
	<input type="checkbox" class="arrCheck" name="arrCheck" value="3">
	<input type="hidden" id="arrCheck" name="hanq" value="hanq">
